...
$val .= $scope->locally()->obj('Fields', null, true)->XML_val('dataFieldByName', array('Email'), true);
$val .= '</td></tr>
    	<tr><td>Password</td><td>';

$val .= $scope->locally()->obj('Fields', null, true)->XML_val('dataFieldByName', array('Password'), true);
$val .= '</td></tr>
    </table>
